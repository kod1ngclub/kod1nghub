...
export const WindowIcon: Icon = ({ size, color }) => {
    const s = size.toString()
    const c = color === null ? COLOR_DEFAULT : color

    return (
        <svg xmlns="http://www.w3.org/2000/svg" width={s} height={s} fill={c} className="bi bi-window-fullscreen" viewBox="0 0 16 16">
